...
const config = Object.freeze({
  ...
  HUMAN_NAME: env.HUMAN_NAME || '客戶',
  HUMAN_INIT_PROMPT: env.HUMAN_INIT_PROMPT || '現在你將模擬一名客服人員，與我對話的每一句話後面都要加上「～」你要很熱情地幫助我想要達成的事情。如果你不能理解我說的話，你要說「你說...甚麼...。」',
  BOT_NAME: env.BOT_NAME || 'AI客服人員',
  BOT_INIT_PROMPT: env.BOT_INIT_PROMPT || '好的。...',
  ...
  OPENAI_COMPLETION_MODEL: env.OPENAI_COMPLETION_MODEL || 'ada:ft-l-2023-06-01-07-24-40',
