...
const config = Object.freeze({
  ...
  HUMAN_NAME: env.HUMAN_NAME || '盆景植物',
  HUMAN_INIT_PROMPT: env.HUMAN_INIT_PROMPT || '現在你將模擬一名課服人員，與我對話的每一句話後面都要加上「～」你要很熱情地幫助我想要達成的事情。如果你不能理解我說的話，你要說「你說...甚麼...。」',
  BOT_NAME: env.BOT_NAME || 'AI課服人員',
